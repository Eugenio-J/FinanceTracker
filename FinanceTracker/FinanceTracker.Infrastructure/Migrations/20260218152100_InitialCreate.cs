        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalaryCycles_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    DistributionType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalaryDistributions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SalaryDistributions_Accounts_TargetAccountId",
                        column: x => x.TargetAccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SalaryDistributions_SalaryCycles_SalaryCycleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalaryCycles_PayDate",
                table: "SalaryCycles",
                column: "PayDate");

            migrationBuilder.CreateIndex(
                name: "IX_SalaryCycles_UserId",
                table: "SalaryCycles",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SalaryDistributions_SalaryCycleId",
                table: "SalaryDistributions",
                column: "SalaryCycleId");

            migrationBuilder.CreateIndex(
                name: "IX_SalaryDistributions_TargetAccountId",
                table: "SalaryDistributions",
